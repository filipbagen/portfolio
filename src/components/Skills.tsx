  ...
  return (
    <div className="flex flex-col items-center sm:items-start bg-custom-gradient-skills dark:bg-custom-gradient-skills-dark rounded-[56px] p-28">
      ...
      <div className="grid lg:grid-cols-2 gap-12 sm:w-full sm:mx-auto justify-items-center">
        <SkillCard
          imageSrc="src/assets/emoji/robot_face.png"
        ...
        <SkillCard
          imageSrc="src/assets/emoji/computer.png"
        ...
        <SkillCard
          imageSrc="src/assets/emoji/star2.png"
        ...
        <SkillCard
          imageSrc="src/assets/emoji/art.png"
          title="UI/UX Design "
        ...
        <SkillCard
          imageSrc="src/assets/emoji/rocket.png"
        ...
        <SkillCard
          imageSrc="src/assets/emoji/pizza.png"
          title="Cooking"
